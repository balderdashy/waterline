...
module.exports = function ORM() {
  ...
  orm.initialize = function initialize(options, cb) {
    ...
    if (!_.isUndefined(options.connections)){
      if (!(_.isUndefined(options.datastores))) { throw new Error('Consistency violation: attempted to provide backwards-compatibility for `connections`, but `datastores` were ALSO provided!'); }
