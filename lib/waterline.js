...
module.exports = function ORM() {
  ...
  orm.initialize = function initialize(options, cb) {
    ...
    if (!_.isUndefined(options.connections)){
      if (process.env.NODE_ENV !== 'production') { assert(_.isUndefined(options.datastores), 'Attempted to provide backwards-compatibility for `connections`, but `datastores` were ALSO provided!'); }
