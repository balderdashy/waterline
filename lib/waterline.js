...
module.exports = function ORM() {
   ...
   * .getModel()
   *
   * Look up one of this ORM's models by identity.
   ...
   * ------------------------------------------------------------------------------------------
   */
  orm.getModel = function (modelIdentity){
    return getModel(modelIdentity, this);
  };
 ...
 *         @property {Dictionary?} defaults (default model settings)
 *
 * @param {Function} done
 *        @param {Error?} err
 *        @param {Ref} orm
...
module.exports.start = function (options, done){
  ...
  // FUTURE: Implement this as an easier way to set up an ORM instance.
  return done(new Error('This is an experimental work in progress -- it has not been fully implemented yet.'));
...
module.exports.stop = function (orm, done){
  ...
  // FUTURE: Implement this as an easier way to tear down an ORM instance.
  return done(new Error('This is an experimental work in progress -- it has not been fully implemented yet.'));
