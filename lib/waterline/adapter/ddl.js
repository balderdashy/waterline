...
module.exports = {
  ...
  define: function(cb) {
    ...
    var attributes = this.query._schema || {};
    ...
    this.describe(function(err, existingAttributes) {
      ...
      self.adapter.define(self.collection, self.query._schema, cb);
    });
  },
  ...
  alter: function(cb) {
    ...
    if(this.adapter.alter) {
      return this.adapter.alter(this.query._schema, cb);
    }
    ...
    if(this.adapter.addAttribute && this.adapter.removeAttribute) {
      ...
      self.describe(function afterDescribe(err, originalAttributes) {
        ...
        _.each(self.query._schema, function checkAttribute(attribute, attrName) {
        ...
        _.each(originalAttributes, function (attribute, attrName) {
          ...
          if (!self.query._schema[attrName]) {
