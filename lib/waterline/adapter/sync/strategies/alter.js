...
module.exports = function(cb) {
  ...
  self.describe(function afterDescribe(err, attrs) {
    ...
    self.find({}, function (err, existingData) {
      ...
      var attrs = self.query.waterline.collections[self.collection]._attributes;
      var pk = self.query.waterline.collections[self.collection].primaryKey;
