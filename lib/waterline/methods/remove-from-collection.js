...
var removeFromCollectionHelper = require('../utils/collection-operations/remove-from-collection');
...
module.exports = function removeFromCollection(/* targetRecordIds?, collectionAttrName?, associatedIds?, done?, meta? */) {
  ...
  if (!done) {
    return new Deferred(this, removeFromCollection, query);
  } // --•
  ...
  removeFromCollectionHelper(query, this.waterline, done);
};
