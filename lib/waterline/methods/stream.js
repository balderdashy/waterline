...
module.exports = function stream( /* criteria?, eachRecordFn?, explicitCbMaybe?, meta?, moreQueryKeys? */ ) {
  ...
  // Creating an array of the model attribute names to make sure our default sort works correctly
  var modelAttributes = _.keysIn(this._transformer._transformations);
  ...
  return parley(
    ...
    function (done){
      ...
      var i = 0;
      var defaultSortCriteria = [];
      if(_.contains(modelAttributes, 'id')){
        defaultSortCriteria = [{id: 'ASC'}];
      }
      ...
      function _beginBatchMaybe(next) {
        ...
        var criteriaForThisBatch = {
          ...
          sort: query.criteria.sort.length ? query.criteria.sort : defaultSortCriteria,
