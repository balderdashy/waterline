...
module.exports = function stream( /* criteria?, eachRecordFn?, moreQueryKeys?, explicitCbMaybe?, meta? */ ) {
  ...
  (function _handleVariadicUsage(){
    ...
    //
    // • stream(..., _moreQueryKeys, explicitCbMaybe, _meta)
