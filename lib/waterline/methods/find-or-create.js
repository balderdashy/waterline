...
module.exports = function findOrCreate( /* criteria?, newRecord?, explicitCbMaybe?, meta? */ ) {
  ...
  return parley(
    ...
    function (done){
      ...
      // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
      // TODO: Figure out how best to not encrypt if query.method is findOrCreate
      // https://github.com/balderdashy/sails/issues/4302#issuecomment-363883885
      // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
      ...
      WLModel.findOne(query.criteria, function _afterPotentiallyFinding(err, foundRecord) {
        ...
        var modifiedMetaForCreate = _.extend({}, query.meta || {}, { fetch: true });
