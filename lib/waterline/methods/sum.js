...
module.exports = function sum( /* numericAttrName?, criteria?, moreQueryKeys?, explicitCbMaybe?, meta? */ ) {
  ...
  (function _handleVariadicUsage(){
    ...
    //
    // • sum(..., criteria, explicitCbMaybe, _meta)
    ...
    //
    // • sum(..., ..., _moreQueryKeys, explicitCbMaybe, _meta)
