  ...
  return parley(
    ...
    function (done){
      ...
      (function (proceed){
        ...
        // new realities of the association.  They'll all be either (A) nulled out or (B) set
        // to the same fk.  That's because there should only ever be either (B) exactly one
        // target record with >=1 new child records to associate or (A) >=1 target records with
