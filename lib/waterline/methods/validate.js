...
module.exports = function validate(attrName, value) {
  ...
  try {
    ...
    switch (e.code) {
      ...
      //   // TODO: if this is a required attribute, then this is actually an error.
      //   // -- but we should handle this in normalizeValueToSet() --
      //   break;

      // Validation failure
      // (type safety, requiredness, or ruleset)
      case 'E_VALIDATION':
        throw e;
