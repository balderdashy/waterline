...
var forgeStage2Query = require('../../utils/forge-stage-2-query');
...
module.exports = function addToCollection(targetRecordIds, associationName, associatedIds, cb, metaContainer) {
  ...
  //
  // > This ensures a normalized format for query objects.
  var q2;
  try {
    q2 = forgeStage2Query({
