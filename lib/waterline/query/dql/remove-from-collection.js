...
module.exports = function removeFromCollection(targetRecordIds, associationName, associatedIdsToRemove, cb, metaContainer) {
  ...
  if (targetRecordIds.length === 0) {
    throw new Error('Usage error: The first argument passed to `.removeFromCollection()` should be the ID (or IDs) of target records whose associated collection will be modified.  But instead got an empty array!');
  }
