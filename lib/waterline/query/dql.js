...
module.exports = {
  ...
  join: function(collection, fk, pk, cb) {
    ...
    this._adapter.adapter.join(collection, fk, pk, cb);
  },
  ...
  create: function(values, cb) {
    ...
    this._validator.validate(values, function(err) {
      ...
      self._adapter.adapter.create(values, function(err, values) {
        if(err) return cb(err);
  ...
  update: function(options, newValues, cb) {
    ...
    this._validator.validate(newValues, function(err) {
      ...
      // Pass to adapter
      self._adapter.adapter.update(options, newValues, function(err, values) {
        if(err) return cb(err);
  ...
  destroy: function(criteria, cb) {
    ...
    // Pass to adapter
    this._adapter.adapter.destroy(criteria, cb);
  },
  ...
  count: function(criteria, options, cb) {
    ...
    this._adapter.adapter.count(criteria, cb);
  }
