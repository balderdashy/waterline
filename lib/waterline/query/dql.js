...
module.exports = {
  ...
  create: function(values, cb) {
    ...
    async.series([
      ...
      if(self.autoCreatedAt && _.isUndefined(values.createdAt)) values.createdAt = new Date();
      if(self.autoUpdatedAt && _.isUndefined(values.updatedAt)) values.updatedAt = new Date();
  ...
  update: function(options, newValues, cb) {
    ...
    async.series([
      ...
      if(self.autoUpdatedAt && _.isUndefined(newValues.updatedAt)) newValues.updatedAt = new Date();
