  ...
  createEach: function(valuesList, cb) {
    ...
    function validate(record, callback) {
      ...
      async.series([
        ...
        if (self.autoCreatedAt && _.isUndefined(record.createdAt)) record.createdAt = new Date();
        if (self.autoUpdatedAt && _.isUndefined(record.updatedAt)) record.updatedAt = new Date();
