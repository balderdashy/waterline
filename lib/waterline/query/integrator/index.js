...
module.exports = function integrate(cache, joinInstructions, primaryKey, cb) {
  ...
  // console.log('in integrator, initial results=', results);
  ...
  _.each( _.groupBy(joinInstructions, 'alias'),
    function eachAssociation( instructions, alias ) {
      ...
      // console.log('in integrator, populating '+alias);
      ...
      // 1..N Association
        ...
        // console.log('in integrator, with a 1..N association, "'+alias+'"');
        ...
        // console.log('in integrator, about to call innerJoin() before populating a 1..N association, "'+alias+'"', 'with this stuff:',{
        //   left: cache[instructions[0].parent],
        //   right: cache[instructions[0].child]||[],
        //   leftKey: instructions[0].parentKey,
        //   rightKey: instructions[0].childKey
        ...
        // console.log('in integrator, about to call populate() for a 1..N association, "'+alias+'"', 'with this stuff:',{
        //   parentRows: results,
        //   alias: alias,
