...
Deferred.prototype.populate = function(keyName, criteria) {
  ...
  // Normalize criteria for this populate (i.e. sub-criteria)
  try {

  }
  catch (e) {
    throw new Error(
      util.format('Could not parse sub-criteria passed to `.populate("%s")`:\n%s', keyName, util.inspect(criteria, false, null))+
