...
//   // this._wlQueryInfo.criteria.joins = ....
...
Deferred.prototype.where = function(criteria) {
  ...
  if (!this._wlQueryInfo.criteria) this._wlQueryInfo.criteria = {};
...
Deferred.prototype.exec = function(cb) {
  ...
  if (this._wlQueryInfo.values) args.splice(1, 0, this._wlQueryInfo.values);
