 ...
 * 
 * @param  {String} keyName - The initial alias (named association)
...
Deferred.prototype.populateDeep = function ( keyName, criteria ) {
  ...
  // The initial alias (named association)
  // keyName
  ...
  traverseSchemaGraph(identity, keyName);

  function traverseSchemaGraph (modelIdentity, nameOfRelation) {

    var currentModel = schema[modelIdentity];
    var currentAttributes = thisModel.attributes;
    
    // If Model.keyName has already been traversed, return.
    // TODO
