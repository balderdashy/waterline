...
Deferred.prototype.populatePath = function(path, criteria) {
  ...
  this._criteria.joins = Array.prototype.concat(this._criteria.joins || [], joins);console.log('Joins',require('util').inspect(this._criteria.joins,{depth : null}));
...
Deferred.prototype.execDeep = function(cb, deepJoins, res){
  ...
  if(!res){
    ...
    async.each(this._criteria.joins, function(join, next) {
      ...
      var criteria = {select : [childPk], where : where, joins : joins};
