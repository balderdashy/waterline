...
finder.buildDynamicFinders = function() {
  ...
  _.forOwn(this._schema.schema, function(attr, attrName) {
...
finder.generateDynamicFinder = function(attrName, method, dontCapitalize) {
  ...
  var preparedAttrName = dontCapitalize ? attrName : _.capitalize(attrName);
  ...
  this[actualMethodName] = function dynamicMethod(value, options, cb) {
    ...
    var usage = _.capitalize(self.identity) + '.' + actualMethodName + '(someValue,[options],callback)';
...
finder.generateAssociationFinders = function(attrName) {
  ...
  this['findOneBy' + _.capitalize(name)] = function dynamicAssociationMethod(value, cb) {

    // Check proper usage
    var usage = _.capitalize(self.identity) + '.' + 'findBy' + _.capitalize(name) +
      '(someValue, callback)';

    if(typeof value === 'undefined' || typeof value === 'function') {
      return usageError('No value specified!', usage, cb);
    }
  ...
  this['findBy' + _.capitalize(name)] = function dynamicAssociationMethod(value, cb) {
...
function buildJoin() {
  ...
  _.forOwn(self._attributes, function(attr, key) {
