...
module.exports = {
  ...
  // Returns the statistical report by the specified attribute
  overviewBy : function (attr, criteria, options, cb, attrVariations) {
    var usage = utils.capitalize(this.identity) + '.overviewBy(attr, [criteria],[options],callback,[variations])';
    ...
    var variations = {};
    variations [attr] = attrVariations || false;
    this.overview (criteria, options, cb, variations);
  },
