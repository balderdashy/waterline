...
module.exports = function(obj, cb) {
  ...
  // `through` model.
  _.each(junctionCollections, function (wl1Collection) {
    // console.log('********************junction:'+wl1Collection.identity+'\n',wl1Collection);
  });

  // Now that everything's in there, give it a shake and kick it out the door
  orm.refresh();
