...
module.exports = {
  ...
  findOne: function(criteria, cb) {
    ...
    operations.run(function(err, values) {
      ...
      // If values are invalid (not an array) return early
      // to avoid getting into trouble.
      // 
      // TODO: consider returning an error here instead-- need to find out -why- this is happening.
      if(!values || !values.forEach) return cb();
