...
module.exports = function(model, schema, values) {
  ...
  Object.keys(values).forEach(function(key) {
    ...
    // assert(typeof attribute !== 'object', util.format('Consistency violation in `utils/nestedOperations/reduceAssociations.js`: `values` specifies an attribute "%s" which doesn\'t exist in schema (model: "%s")', key, model));
