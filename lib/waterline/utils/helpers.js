...
exports.pluralize = function pluralize(collection, application) {
  if(_.isArray(collection)) return _.map(collection, application);
...
/**
 * Simple helper for hasOwnProperty, similar to _.property
 * or _.partial(_.has, _);
 *
 * @param {String} prop
 * @return {Function}
 * @api public
 */
exports.object.hasProperty = function(property) {
  return function(obj) {
