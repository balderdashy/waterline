...
var normalize = module.exports = {
  ...
  criteria: function(origCriteria) {
    ...
    if(!hop(criteria, 'where') && !hop(criteria, 'joins') && !hop(criteria, 'join') &&
      !hop(criteria, 'limit') && !hop(criteria, 'skip') && !hop(criteria, 'sort') &&
      !hop(criteria, 'sum') && !hop(criteria, 'average') && !hop(criteria, 'groupBy') &&
      !hop(criteria, 'min') && !hop(criteria, 'max')) {
    ...
    if(criteria.where && hop(criteria.where, 'like')) {
