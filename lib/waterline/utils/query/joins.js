    ...
    _.each(_.keys(value), function(key) {
      ...
      if (_.isArray(value[key])) {
        ...
        _.each(value[key], function(val) {
          ...
          if (joinKey) {
            collection = collections[joinKey.toLowerCase()];
          ...
          collection = collections[usedInJoin.childCollectionIdentity.toLowerCase()];
          val = collection._transformer.unserialize(val);
          records.push(val);
          return;
        });
      ...
      var collection = collections[joinKey.toLowerCase()];
