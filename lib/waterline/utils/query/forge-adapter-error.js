  ...
  try {
    ...
    var customizations = (function(){
      ...
      switch (err.footprint.identity) {
        ...
        // //   ╚══▀▀═╝  ╚═════╝ ╚══════╝╚═╝  ╚═╝   ╚═╝
        // //
        // case 'couldNotParseNativeQuery': return (function(){
        //   return {
        //     message: 'Database could not parse this query.  '+err.message,
        //     // No toJSON because it's very unlikely you'd be serializing this error.
        //     // The additional info is really just for the developer.
        //   };
        // })();
