...
Deferred.prototype.populate = function(keyName, criteria) {
  ...
  this._wlQueryInfo.populates = this._wlQueryInfo.populates || {};
...
Deferred.prototype.withThese =
Deferred.prototype.these = function(associatedIds) {
...
Deferred.prototype.set = function(values) {
  if (this._wlQueryInfo.method === 'update') {
    this._wlQueryInfo.valuesToSet = values;
  } else if (this._wlQueryInfo.method === 'create') {
...
Deferred.prototype.exec = function(cb) {
  ...
  switch (query.method) {
    ...
    // case 'join'://<< this is not supported, right?
