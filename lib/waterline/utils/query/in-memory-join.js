...
var sortMongoStyle = require('./private/sort-mongo-style');
 ...
 * @param  {[type]}   primaryKeyColumnName [description]
 * @return {[type]}              [description]
 */
module.exports = function inMemoryJoins(query, cache, primaryKeyColumnName) {
  var results;
  try {
    results = integrate(cache, query.joins, primaryKeyColumnName);
  } catch (e) {
    throw e;
  }
