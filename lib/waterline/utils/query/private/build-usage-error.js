...
var USAGE_ERR_MSG_TEMPLATES = {
  ...
  E_VALIDATION: _.template(
    ...
    '\n'
    // ========================================================
    // TODO: Expand this template to also rely on additional information (it's a special case)
    //
    // example from Waterline <=v0.12:
    // ```
