  ...
  (function _recursiveStep(branch, recursionDepth, parent, indexInParent){
    ...
    if (origBranchKeys.length === 0) {
      ...
      // Otherwise, it means something is invalid.
        ...
        // TODO: instead of calling the whole thing unusable, treat this in the same way
        // we treat a `E_FILTER_WOULD_MATCH_ANYTHING` exception coming from `normalizeFilter()`
