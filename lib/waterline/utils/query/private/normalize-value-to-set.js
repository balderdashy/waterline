 ...
 */
module.exports = function normalizeValueToSet(value, supposedAttrName, modelIdentity, orm, currentTimestamp, ensureTypeSafety, allowCollectionAttrs) {
  ...
  if (!correspondingAttrDef) {
    ...
    if (_.isNull(value)) {
      ...
      else if (!_.isUndefined(correspondingAttrDef.autoUpdatedAt)) {
