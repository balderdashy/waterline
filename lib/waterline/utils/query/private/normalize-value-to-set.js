 ...
 *        Optional.  If provided and set to `true`, then `value` will be permitted to
 *        contain properties for plural ("collection") associations.  Otherwise, attempting
 *        to do so will fail with E_HIGHLY_IRREGULAR.
 *
 * --
 *
 * @returns {Dictionary}
