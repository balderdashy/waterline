  ...
  // > We'll use loose validation (& thus also light coercion) on the value and see what happens.
    ...
    if (correspondingAttrDef.autoCreatedAt || correspondingAttrDef.autoUpdatedAt) {
      ...
      console.warn('\n'+
        ...
        '(This attribute is defined as `'+autoTSDisplayName+': true`, meaning it is intended '+
        'to be set automatically, except in special cases when debugging or migrating data.)\n'
      );
