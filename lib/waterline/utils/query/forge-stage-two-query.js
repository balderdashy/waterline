...
module.exports = function forgeStageTwoQuery(query, orm) {
  ...
  // Set the `collectionsNotUsingObjectIds` meta key of the query to an array of identities of
  // collections that have declared that their primary keys are NOT ObjectIDs.
  query.meta = query.meta || {};
  query.meta.collectionsNotUsingObjectIds = _.reduce(orm.collections, function(memo, collection) {
