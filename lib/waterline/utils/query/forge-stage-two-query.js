...
module.exports = function forgeStageTwoQuery(query, orm) {
  ...
  //  │││├┤  │ ├─┤  ├┴┐├┤ └┬┘  │   ├┤ │ │├┬┘  ││││ │││││ ┬│ │   │
  //  ┴ ┴└─┘ ┴ ┴ ┴  ┴ ┴└─┘ ┴   └─  └  └─┘┴└─  ┴ ┴└─┘┘└┘└─┘└─┘  ─┘
  // Set the `mongoCollectionsNotUsingObjectIds` meta key of the query based on
  ...
  query.meta = query.meta || {};
  (function() {
    var mongoCollectionsNotUsingObjectIds = _.reduce(orm.collections, function(memo, WLModel) {
