...
module.exports = function forgeStageTwoQuery(query, orm) {
  ...
  //  │  ├─┤└─┐│  ├─┤ ││├┤   │ ││││   ││├┤ └─┐ │ ├┬┘│ │└┬┘ ┌┘
  //  └─┘┴ ┴└─┘└─┘┴ ┴─┴┘└─┘  └─┘┘└┘  ─┴┘└─┘└─┘ ┴ ┴└─└─┘ ┴  o
  if (!_.isUndefined(WLModel.cascadeOnDestroy)) {
    assert(_.isBoolean(WLModel.cascadeOnDestroy));
    query.meta = query.meta || {};
    query.meta.cascadeOnDestroy = WLModel.cascadeOnDestroy;
  }//>-

  //  ┌─┐┌─┐┌┬┐┌─┐┬ ┬  ┬─┐┌─┐┌─┐┌─┐┬─┐┌┬┐┌─┐  ┌─┐┌┐┌  ┬ ┬┌─┐┌┬┐┌─┐┌┬┐┌─┐┌─┐
  //  ├┤ ├┤  │ │  ├─┤  ├┬┘├┤ │  │ │├┬┘ ││└─┐  │ ││││  │ │├─┘ ││├─┤ │ ├┤  ┌┘
  //  └  └─┘ ┴ └─┘┴ ┴  ┴└─└─┘└─┘└─┘┴└──┴┘└─┘  └─┘┘└┘  └─┘┴  ─┴┘┴ ┴ ┴ └─┘ o
  if (!_.isUndefined(WLModel.fetchRecordsOnUpdate)) {
    assert(_.isBoolean(WLModel.fetchRecordsOnUpdate));
    query.meta = query.meta || {};
    query.meta.fetchRecordsOnUpdate = WLModel.fetchRecordsOnUpdate;
  }//>-

  //  ┌─┐┌─┐┌┬┐┌─┐┬ ┬  ┬─┐┌─┐┌─┐┌─┐┬─┐┌┬┐┌─┐  ┌─┐┌┐┌  ┌┬┐┌─┐┌─┐┌┬┐┬─┐┌─┐┬ ┬┌─┐
  //  ├┤ ├┤  │ │  ├─┤  ├┬┘├┤ │  │ │├┬┘ ││└─┐  │ ││││   ││├┤ └─┐ │ ├┬┘│ │└┬┘ ┌┘
  //  └  └─┘ ┴ └─┘┴ ┴  ┴└─└─┘└─┘└─┘┴└──┴┘└─┘  └─┘┘└┘  ─┴┘└─┘└─┘ ┴ ┴└─└─┘ ┴  o
  if (!_.isUndefined(WLModel.fetchRecordsOnDestroy)) {
    assert(_.isBoolean(WLModel.fetchRecordsOnDestroy));
    query.meta = query.meta || {};
    query.meta.fetchRecordsOnDestroy = WLModel.fetchRecordsOnDestroy;
  }//>-
