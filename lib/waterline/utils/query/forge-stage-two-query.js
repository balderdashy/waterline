...
module.exports = function forgeStageTwoQuery(query, orm) {
  ...
  if (!_.isUndefined(WLModel.cascadeOnDestroy)) {
    ...
    // If `false`, then we just ignore it
  ...
  //  ├┤ ├┤  │ │  ├─┤  ├┬┘├┤ │  │ │├┬┘ ││└─┐  │ ││││  │ │├─┘ ││├─┤ │ ├┤  ┌┘
  //  └  └─┘ ┴ └─┘┴ ┴  ┴└─└─┘└─┘└─┘┴└──┴┘└─┘  └─┘┘└┘  └─┘┴  ─┴┘┴ ┴ ┴ └─┘ o
  if (!_.isUndefined(WLModel.fetchRecordsOnUpdate) && query.method === 'update') {
  ...
  //  ├┤ ├┤  │ │  ├─┤  ├┬┘├┤ │  │ │├┬┘ ││└─┐  │ ││││   ││├┤ └─┐ │ ├┬┘│ │└┬┘ ┌┘
  //  └  └─┘ ┴ └─┘┴ ┴  ┴└─└─┘└─┘└─┘┴└──┴┘└─┘  └─┘┘└┘  ─┴┘└─┘└─┘ ┴ ┴└─└─┘ ┴  o
  if (!_.isUndefined(WLModel.fetchRecordsOnDestroy) && query.method === 'destroy') {
