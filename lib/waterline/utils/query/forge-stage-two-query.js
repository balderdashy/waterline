    ...
    _.each(_.keys(query.populates), function (populateAttrName) {
      ...
      try {
        ...
        switch (e.code) {
          ...
          default: throw new Error('Consistency violation: When attempting to populate `'+populateAttrName+'` for this model (`'+query.using+'`), an unexpected error occurred looking up the association\'s definition.  This SHOULD never happen.  Error details: '+e.stack);
        }
      }//</catch>
