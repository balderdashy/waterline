 ...
 * buildFindOperations()
 *
 * Build an "Operations" instance for use in fetching data for `find` and `findOne`.
 *
 * > The primary responsibility of this file is taking a stage 2 query and determining
 ...
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 */
var Operations = module.exports = function buildFindOperations(WLModel, s2q) {
...
//  ╠╦╝║ ║║║║  │ │├─┘├┤ ├┬┘├─┤ │ ││ ││││└─┐
//  ╩╚═╚═╝╝╚╝  └─┘┴  └─┘┴└─┴ ┴ ┴ ┴└─┘┘└┘└─┘
Operations.prototype.run = function (cb) {
  var self = this;
...
Operations.prototype.seedCache = function () {
 ...
 // fufill the query.
Operations.prototype.buildOperations = function () {
  var operations = [];
...
Operations.prototype.stageOperations = function stageOperations(datastores) {
  var self = this;
  var operations = [];
 ...
 */
Operations.prototype.createParentOperation = function (datastores) {
...
//  ├─┘├┬┘││││├─┤├┬┘└┬┘  ├┴┐├┤ └┬┘
//  ┴  ┴└─┴┴ ┴┴ ┴┴└─ ┴   ┴ ┴└─┘ ┴
Operations.prototype.findCollectionPK = function (identity) {
