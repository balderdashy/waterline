 ...
 * buildFQRunner()
 *
 * Build and return an "FQRunner" instance.
 *
 ...
 *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * > FUTURE: This implementation will likely be simplified in future versions of Waterline.
 * > (for example, the "run" method could simply be exposed as a first-class citizen and
 * > required + called directly in `find()` and in `findOne()`.  This would just involve
 * > making it stateless.)
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
module.exports = function buildFQRunner (WLModel, s2q) {
  return new FQRunner(WLModel, s2q);
};
 ...
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * Reminder:
 * This will likely be superceded w/ a simpler, stateless approach in a future release.
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 *
