 ...
 *
 * Run a set of generated "find" operations, and then perform an in-memory
 * join if needed.  Afterwards, the normalized result set is turned into
...
module.exports = function runFindOperations(operations, stageThreeQuery, WLModel, cb) {
