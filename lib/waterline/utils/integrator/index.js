...
module.exports = function integrate(cache, joinInstructions, primaryKey, cb) {
  ...
  invalid = invalid || anchor(joinInstructions[0].parentCollectionIdentity).to({ type: 'string' });
  invalid = invalid || anchor(cache[joinInstructions[0].parentCollectionIdentity]).to({ type: 'object' });
