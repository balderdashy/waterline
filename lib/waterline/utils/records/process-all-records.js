...
var eachRecordDeep = require('../records/each-record-deep');
...
module.exports = function processAllRecords(records, s2qSelectClause, meta, modelIdentity, orm) {
  ...
  eachRecordDeep(records, function _eachParentOrChildRecord(record, WLModel, depth){
  ...
  }, modelIdentity, orm);//</eachRecordDeep>
