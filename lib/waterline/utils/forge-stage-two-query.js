...
module.exports = function forgeStageTwoQuery(query, orm) {
  ...
  if (!_.isUndefined(query.meta)) {
    ...
    if (!_.isObject(query.meta) || _.isArray(query.meta) || _.isFunction(query.meta)) {
      throw flaverr({ name: 'Usage error', code: 'E_INVALID_META' }, new Error(USAGE_ERR_MSG_TEMPLATES['E_INVALID_META']({details:
    ...
    try {
      ...
      switch (e.code) {
        ...
        case 'E_HIGHLY_IRREGULAR':
          throw flaverr({ name: 'Usage error', code: 'E_INVALID_CRITERIA' }, new Error(USAGE_ERR_MSG_TEMPLATES['E_INVALID_CRITERIA']({details:
            e.message
          })));
  ...
  if (_.contains(queryKeys, 'populates')) {
    ...
    if (!_.isPlainObject(query.populates)) {
      throw flaverr({ name: 'Usage error', code: 'E_INVALID_POPULATES' }, new Error(USAGE_ERR_MSG_TEMPLATES['E_INVALID_POPULATES']({details:
  ...
  if (_.contains(queryKeys, 'numericAttrName')) {
    ...
    if (_.isUndefined(query.numericAttrName)) {
      throw flaverr({ name: 'Usage error', code: 'E_INVALID_NUMERIC_ATTR_NAME' }, new Error(USAGE_ERR_MSG_TEMPLATES['E_INVALID_NUMERIC_ATTR_NAME']({details:
  ...
  if (_.contains(queryKeys, 'newRecord')) {
    ...
    if (!_.isObject(query.newRecord) || _.isFunction(query.newRecord) || _.isArray(query.newRecord)) {
      ...
      throw flaverr({ name: 'Usage error', code: 'E_INVALID_NEW_RECORD' }, new Error(USAGE_ERR_MSG_TEMPLATES['E_INVALID_NEW_RECORD']({details:
        'Expecting a dictionary (plain JavaScript object) but instead, got: '+util.inspect(query.newRecord,{depth:null})
      })));
  ...
  if (_.contains(queryKeys, 'newRecords')) {
    ...
    if (_.isUndefined(query.newRecords)) {
      throw flaverr({ name: 'Usage error', code: 'E_INVALID_NEW_RECORDS' }, new Error(USAGE_ERR_MSG_TEMPLATES['E_INVALID_NEW_RECORDS']({details:
  ...
  if (_.contains(queryKeys, 'valuesToSet')) {
    ...
    if (!_.isObject(query.valuesToSet) || _.isFunction(query.valuesToSet) || _.isArray(query.valuesToSet)) {
      throw flaverr({ name: 'Usage error', code: 'E_INVALID_VALUES_TO_SET' }, new Error(USAGE_ERR_MSG_TEMPLATES['E_INVALID_VALUES_TO_SET']({details:
    ...
    try {
      ...
      switch (e.code) {
        ...
        case 'E_INVALID_PK_VALUE':
          throw flaverr({ name: 'Usage error', code: 'E_INVALID_TARGET_RECORD_IDS' }, new Error(USAGE_ERR_MSG_TEMPLATES['E_INVALID_TARGET_RECORD_IDS']({details:
            e.message
          })));
  ...
  if (_.contains(queryKeys, 'collectionAttrName')) {
    ...
    if (!_.isString(query.collectionAttrName)) {
      throw flaverr({ name: 'Usage error', code: 'E_INVALID_COLLECTION_ATTR_NAME' }, new Error(USAGE_ERR_MSG_TEMPLATES['E_INVALID_COLLECTION_ATTR_NAME']({details:
  ...
  if (_.contains(queryKeys, 'associatedIds')) {
    ...
    try {
      ...
      switch (e.code) {
        ...
        case 'E_INVALID_PK_VALUE':
          throw flaverr({ name: 'Usage error', code: 'E_INVALID_ASSOCIATED_IDS' }, new Error(USAGE_ERR_MSG_TEMPLATES['E_INVALID_ASSOCIATED_IDS']({details:
            e.message
          })));
