...
Schema.prototype.buildCollectionDefinitions = function(collections) {
  ...
  Object.keys(collections).forEach(function(key) {
    ...
    if(collections[key].prototype.tableName) collections[key].prototype.identity = collections[key].prototype.tableName;
    ...
    // var collection = _.clone(collections[key]);
    ...
    self._addAutoAttributes(collection);
