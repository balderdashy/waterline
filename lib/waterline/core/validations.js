  ...
  Object.keys(attrs).forEach(function(attr) {
    ...
    Object.keys(attrs[attr]).forEach(function(prop) {
      ...
      if(['defaultsTo', 'primaryKey', 'autoIncrement', 'unique', 'index', 'collection', 'dominant', 'through',
          ...
          'fieldName',// fieldName===columnName for WL2
          'association',// association===special namespaced metadata object for WL2
          'example', 'validationMessage', 'validations', 'populateSettings', 'onKey', 'protected'].indexOf(prop) > -1) return;
