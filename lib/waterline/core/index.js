...
var Core = module.exports = function(options) {
  ...
  this._attributes = _.clone(this.tables[this.identity].attributes) || {};
  ...
  this._instanceMethods = schemaUtils.instanceMethods(this._attributes);
...
_.extend(Core.prototype, {
  ...
  _initialize: function(options) {
    ...
    this._validator.initialize(this._attributes, this.types);

    // Build Data Transformer
    this._transformer = new Transformer(this._attributes, this.tables);
