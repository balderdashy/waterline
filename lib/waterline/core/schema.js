...
Schema.prototype.addAutoAttributes = function() {
  ...
  if(this.context.autoPK && !this.attributes.id) {
    this.schema.id = {
      type: 'integer',
      autoIncrement: true,
  ...
  if(this.context.autoCreatedAt && !this.attributes.createdAt) this.schema.created_at = now;
  if(this.context.autoUpdatedAt && !this.attributes.updatedAt) this.schema.updated_at = now;
};
